...
export const OpcodesCB: Array<Opcode> = [
	...
	new Opcode(0x80, "RES 0,(IX%s),B"),
	new Opcode(0x81, "RES 0,(IX%s),C"),
	new Opcode(0x82, "RES 0,(IX%s),D"),
	new Opcode(0x83, "RES 0,(IX%s),E"),
	new Opcode(0x84, "RES 0,(IX%s),H"),
	new Opcode(0x85, "RES 0,(IX%s),L"),
	new Opcode(0x86, "RES 0,(HL)"),
	new Opcode(0x87, "RES 0,(IX%s),A"),
	new Opcode(0x88, "RES 1,(IX%s),B"),
	new Opcode(0x89, "RES 1,(IX%s),C"),
	new Opcode(0x8A, "RES 1,(IX%s),D"),
	new Opcode(0x8B, "RES 1,(IX%s),E"),
	new Opcode(0x8C, "RES 1,(IX%s),H"),
	new Opcode(0x8D, "RES 1,(IX%s),L"),
	new Opcode(0x8E, "RES 1,(HL)"),
	new Opcode(0x8F, "RES 1,(IX%s),A"),
	new Opcode(0x90, "RES 2,(IX%s),B"),
	new Opcode(0x91, "RES 2,(IX%s),C"),
	new Opcode(0x92, "RES 2,(IX%s),D"),
	new Opcode(0x93, "RES 2,(IX%s),E"),
	new Opcode(0x94, "RES 2,(IX%s),H"),
	new Opcode(0x95, "RES 2,(IX%s),L"),
	new Opcode(0x96, "RES 2,(HL)"),
	new Opcode(0x97, "RES 2,(IX%s),A"),
	new Opcode(0x98, "RES 3,(IX%s),B"),
	new Opcode(0x99, "RES 3,(IX%s),C"),
	new Opcode(0x9A, "RES 3,(IX%s),D"),
	new Opcode(0x9B, "RES 3,(IX%s),E"),
	new Opcode(0x9C, "RES 3,(IX%s),H"),
	new Opcode(0x9D, "RES 3,(IX%s),L"),
	new Opcode(0x9E, "RES 3,(HL)"),
	new Opcode(0x9F, "RES 3,(IX%s),A"),
	new Opcode(0xA0, "RES 4,(IX%s),B"),
	new Opcode(0xA1, "RES 4,(IX%s),C"),
	new Opcode(0xA2, "RES 4,(IX%s),D"),
	new Opcode(0xA3, "RES 4,(IX%s),E"),
	new Opcode(0xA4, "RES 4,(IX%s),H"),
	new Opcode(0xA5, "RES 4,(IX%s),L"),
	new Opcode(0xA6, "RES 4,(HL)"),
	new Opcode(0xA7, "RES 4,(IX%s),A"),
	new Opcode(0xA8, "RES 5,(IX%s),B"),
	new Opcode(0xA9, "RES 5,(IX%s),C"),
	new Opcode(0xAA, "RES 5,(IX%s),D"),
	new Opcode(0xAB, "RES 5,(IX%s),E"),
	new Opcode(0xAC, "RES 5,(IX%s),H"),
	new Opcode(0xAD, "RES 5,(IX%s),L"),
	new Opcode(0xAE, "RES 5,(HL)"),
	new Opcode(0xAF, "RES 5,(IX%s),A"),
	new Opcode(0xB0, "RES 6,(IX%s),B"),
	new Opcode(0xB1, "RES 6,(IX%s),C"),
	new Opcode(0xB2, "RES 6,(IX%s),D"),
	new Opcode(0xB3, "RES 6,(IX%s),E"),
	new Opcode(0xB4, "RES 6,(IX%s),H"),
	new Opcode(0xB5, "RES 6,(IX%s),L"),
	new Opcode(0xB6, "RES 6,(HL)"),
	new Opcode(0xB7, "RES 6,(IX%s),A"),
	new Opcode(0xB8, "RES 7,(IX%s),B"),
	new Opcode(0xB9, "RES 7,(IX%s),C"),
	new Opcode(0xBA, "RES 7,(IX%s),D"),
	new Opcode(0xBB, "RES 7,(IX%s),E"),
	new Opcode(0xBC, "RES 7,(IX%s),H"),
	new Opcode(0xBD, "RES 7,(IX%s),L"),
	new Opcode(0xBE, "RES 7,(HL)"),
	new Opcode(0xBF, "RES 7,(IX%s),A"),
	new Opcode(0xC0, "SET 0,(IX%s),B"),
	new Opcode(0xC1, "SET 0,(IX%s),C"),
	new Opcode(0xC2, "SET 0,(IX%s),D"),
	new Opcode(0xC3, "SET 0,(IX%s),E"),
	new Opcode(0xC4, "SET 0,(IX%s),H"),
	new Opcode(0xC5, "SET 0,(IX%s),L"),
	new Opcode(0xC6, "SET 0,(HL)"),
	new Opcode(0xC7, "SET 0,(IX%s),A"),
	new Opcode(0xC8, "SET 1,(IX%s),B"),
	new Opcode(0xC9, "SET 1,(IX%s),C"),
	new Opcode(0xCA, "SET 1,(IX%s),D"),
	new Opcode(0xCB, "SET 1,(IX%s),E"),
	new Opcode(0xCC, "SET 1,(IX%s),H"),
	new Opcode(0xCD, "SET 1,(IX%s),L"),
	new Opcode(0xCE, "SET 1,(HL)"),
	new Opcode(0xCF, "SET 1,(IX%s),A"),
	new Opcode(0xD0, "SET 2,(IX%s),B"),
	new Opcode(0xD1, "SET 2,(IX%s),C"),
	new Opcode(0xD2, "SET 2,(IX%s),D"),
	new Opcode(0xD3, "SET 2,(IX%s),E"),
	new Opcode(0xD4, "SET 2,(IX%s),H"),
	new Opcode(0xD5, "SET 2,(IX%s),L"),
	new Opcode(0xD6, "SET 2,(HL)"),
	new Opcode(0xD7, "SET 2,(IX%s),A"),
	new Opcode(0xD8, "SET 3,(IX%s),B"),
	new Opcode(0xD9, "SET 3,(IX%s),C"),
	new Opcode(0xDA, "SET 3,(IX%s),D"),
	new Opcode(0xDB, "SET 3,(IX%s),E"),
	new Opcode(0xDC, "SET 3,(IX%s),H"),
	new Opcode(0xDD, "SET 3,(IX%s),L"),
	new Opcode(0xDE, "SET 3,(HL)"),
	new Opcode(0xDF, "SET 3,(IX%s),A"),
	new Opcode(0xE0, "SET 4,(IX%s),B"),
	new Opcode(0xE1, "SET 4,(IX%s),C"),
	new Opcode(0xE2, "SET 4,(IX%s),D"),
	new Opcode(0xE3, "SET 4,(IX%s),E"),
	new Opcode(0xE4, "SET 4,(IX%s),H"),
	new Opcode(0xE5, "SET 4,(IX%s),L"),
	new Opcode(0xE6, "SET 4,(HL)"),
	new Opcode(0xE7, "SET 4,(IX%s),A"),
	new Opcode(0xE8, "SET 5,(IX%s),B"),
	new Opcode(0xE9, "SET 5,(IX%s),C"),
	new Opcode(0xEA, "SET 5,(IX%s),D"),
	new Opcode(0xEB, "SET 5,(IX%s),E"),
	new Opcode(0xEC, "SET 5,(IX%s),H"),
	new Opcode(0xED, "SET 5,(IX%s),L"),
	new Opcode(0xEE, "SET 5,(HL)"),
	new Opcode(0xEF, "SET 5,(IX%s),A"),
	new Opcode(0xF0, "SET 6,(IX%s),B"),
	new Opcode(0xF1, "SET 6,(IX%s),C"),
	new Opcode(0xF2, "SET 6,(IX%s),D"),
	new Opcode(0xF3, "SET 6,(IX%s),E"),
	new Opcode(0xF4, "SET 6,(IX%s),H"),
	new Opcode(0xF5, "SET 6,(IX%s),L"),
	new Opcode(0xF6, "SET 6,(HL)"),
	new Opcode(0xF7, "SET 6,(IX%s),A"),
	new Opcode(0xF8, "SET 7,(IX%s),B"),
	new Opcode(0xF9, "SET 7,(IX%s),C"),
	new Opcode(0xFA, "SET 7,(IX%s),D"),
	new Opcode(0xFB, "SET 7,(IX%s),E"),
	new Opcode(0xFC, "SET 7,(IX%s),H"),
	new Opcode(0xFD, "SET 7,(IX%s),L"),
	new Opcode(0xFE, "SET 7,(HL)"),
	new Opcode(0xFF, "SET 7,(IX%s),A")
];
// Fix length (2)
...
export const OpcodesDDCB: Array<Opcode> = [
	new OpcodeIndex(0x00, "RLC (IX%s),B)"),
	new OpcodeIndex(0x01, "RLC (IX%s),C"),
	new OpcodeIndex(0x02, "RLC (IX%s),D"),
	new OpcodeIndex(0x03, "RLC (IX%s),E"),
	new OpcodeIndex(0x04, "RLC (IX%s),H"),
	new OpcodeIndex(0x05, "RLC (IX%s),L"),
	new OpcodeIndex(0x06, "RLC (IX%s)"),
	new OpcodeIndex(0x07, "RLC (IX%s),A"),
	new OpcodeIndex(0x08, "RRC (IX%s),B"),
	new OpcodeIndex(0x09, "RRC (IX%s),C"),
	new OpcodeIndex(0x0A, "RRC (IX%s),D"),
	new OpcodeIndex(0x0B, "RRC (IX%s),E"),
	new OpcodeIndex(0x0C, "RRC (IX%s),H"),
	new OpcodeIndex(0x0D, "RRC (IX%s),L"),
	new OpcodeIndex(0x0E, "RRC (IX%s)"),
	new OpcodeIndex(0x0F, "RRC (IX%s),A"),
	new OpcodeIndex(0x10, "RL (IX%s),B"),
	new OpcodeIndex(0x11, "RL (IX%s),C"),
	new OpcodeIndex(0x12, "RL (IX%s),D"),
	new OpcodeIndex(0x13, "RL (IX%s),E"),
	new OpcodeIndex(0x14, "RL (IX%s),H"),
	new OpcodeIndex(0x15, "RL (IX%s),L"),
	new OpcodeIndex(0x16, "RL (IX%s)"),
	new OpcodeIndex(0x17, "RL (IX%s),A"),
	new OpcodeIndex(0x18, "RR (IX%s),B"),
	new OpcodeIndex(0x19, "RR (IX%s),C"),
	new OpcodeIndex(0x1A, "RR (IX%s),D"),
	new OpcodeIndex(0x1B, "RR (IX%s),E"),
	new OpcodeIndex(0x1C, "RR (IX%s),H"),
	new OpcodeIndex(0x1D, "RR (IX%s),L"),
	new OpcodeIndex(0x1E, "RR (IX%s)"),
	new OpcodeIndex(0x1F, "RR (IX%s),A"),
	new OpcodeIndex(0x20, "SLA (IX%s),B"),
	new OpcodeIndex(0x21, "SLA (IX%s),C"),
	new OpcodeIndex(0x22, "SLA (IX%s),D"),
	new OpcodeIndex(0x23, "SLA (IX%s),E"),
	new OpcodeIndex(0x24, "SLA (IX%s),H"),
	new OpcodeIndex(0x25, "SLA (IX%s),L"),
	new OpcodeIndex(0x26, "SLA (IX%s)"),
	new OpcodeIndex(0x27, "SLA (IX%s),A"),
	new OpcodeIndex(0x28, "SRA (IX%s),B"),
	new OpcodeIndex(0x29, "SRA (IX%s),C"),
	new OpcodeIndex(0x2A, "SRA (IX%s),D"),
	new OpcodeIndex(0x2B, "SRA (IX%s),E"),
	new OpcodeIndex(0x2C, "SRA (IX%s),H"),
	new OpcodeIndex(0x2D, "SRA (IX%s),L"),
	new OpcodeIndex(0x2E, "SRA (IX%s)"),
	new OpcodeIndex(0x2F, "SRA (IX%s),A"),
	new OpcodeIndex(0x30, "SLL (IX%s),B"),
	new OpcodeIndex(0x31, "SLL (IX%s),C"),
	new OpcodeIndex(0x32, "SLL (IX%s),D"),
	new OpcodeIndex(0x33, "SLL (IX%s),E"),
	new OpcodeIndex(0x34, "SLL (IX%s),H"),
	new OpcodeIndex(0x35, "SLL (IX%s),L"),
	new OpcodeIndex(0x36, "SLL (IX%s)"),
	new OpcodeIndex(0x37, "SLL (IX%s),A"),
	new OpcodeIndex(0x38, "SRL (IX%s),B"),
	new OpcodeIndex(0x39, "SRL (IX%s),C"),
	new OpcodeIndex(0x3A, "SRL (IX%s),D"),
	new OpcodeIndex(0x3B, "SRL (IX%s),E"),
	new OpcodeIndex(0x3C, "SRL (IX%s),H"),
	new OpcodeIndex(0x3D, "SRL (IX%s),L"),
	new OpcodeIndex(0x3E, "SRL (IX%s)"),
	new OpcodeIndex(0x3F, "SRL (IX%s),A"),
	new OpcodeIndex(0x40, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x41, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x42, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x43, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x44, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x45, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x46, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x47, "BIT 0,(IX%s)"),
	new OpcodeIndex(0x48, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x49, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x4A, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x4B, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x4C, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x4D, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x4E, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x4F, "BIT 1,(IX%s)"),
	new OpcodeIndex(0x50, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x51, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x52, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x53, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x54, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x55, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x56, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x57, "BIT 2,(IX%s)"),
	new OpcodeIndex(0x58, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x59, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x5A, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x5B, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x5C, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x5D, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x5E, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x5F, "BIT 3,(IX%s)"),
	new OpcodeIndex(0x60, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x61, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x62, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x63, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x64, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x65, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x66, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x67, "BIT 4,(IX%s)"),
	new OpcodeIndex(0x68, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x69, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x6A, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x6B, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x6C, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x6D, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x6E, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x6F, "BIT 5,(IX%s)"),
	new OpcodeIndex(0x70, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x71, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x72, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x73, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x74, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x75, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x76, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x77, "BIT 6,(IX%s)"),
	new OpcodeIndex(0x78, "BIT 7,(IX%s)"),
	new OpcodeIndex(0x79, "BIT 7,(IX%s)"),
	new OpcodeIndex(0x7A, "BIT 7,(IX%s)"),
	new OpcodeIndex(0x7B, "BIT 7,(IX%s)"),
	new OpcodeIndex(0x7C, "BIT 7,(IX%s)"),
	new OpcodeIndex(0x7D, "BIT 7,(IX%s)"),
	new OpcodeIndex(0x7E, "BIT 7,(IX%s)"),
	new OpcodeIndex(0x7F, "BIT 7,(IX%s)"),
	...
	new OpcodeIndex(0x86, "RES 0,(IX%s)"),
	...
	new OpcodeIndex(0x8E, "RES 1,(IX%s)"),
	...
	new OpcodeIndex(0x96, "RES 2,(IX%s)"),
	...
	new OpcodeIndex(0x9E, "RES 3,(IX%s)"),
	...
	new OpcodeIndex(0xA6, "RES 4,(IX%s)"),
	...
	new OpcodeIndex(0xAE, "RES 5,(IX%s)"),
	...
	new OpcodeIndex(0xB6, "RES 6,(IX%s)"),
	...
	new OpcodeIndex(0xBE, "RES 7,(IX%s)"),
	...
	new OpcodeIndex(0xC6, "SET 0,(IX%s)"),
	...
	new OpcodeIndex(0xCE, "SET 1,(IX%s)"),
	...
	new OpcodeIndex(0xD6, "SET 2,(IX%s)"),
	...
	new OpcodeIndex(0xDE, "SET 3,(IX%s)"),
	...
	new OpcodeIndex(0xE6, "SET 4,(IX%s)"),
	...
	new OpcodeIndex(0xEE, "SET 5,(IX%s)"),
	...
	new OpcodeIndex(0xF6, "SET 6,(IX%s)"),
	...
	new OpcodeIndex(0xFE, "SET 7,(IX%s)"),
...
export const OpcodesFDCB = OpcodesDDCB.map(opcode => {
	const opcodeFDCB = new OpcodeIndex();
