...
export const OpcodesDDCB: Array<Opcode> = [
	...
	new OpcodeIndex(0xFD, "SET 7,(IX%s),L"),
	new Opcode(0xFE, "SET 7,(IX%s)"),
	new OpcodeIndex(0xFF, "SET 7,(IX%s),A")
];
// Fix length (4)
