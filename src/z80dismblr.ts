...
z80dismblr [options]
    ...
    Formatting options:
        ...
        Labels options:
        --lblsout file: Output a file with the labels. Additionally the comments
            generated by z80dismblr are outptu as well. A file generated with '--lblsout'
            can be modified manually and then read in again via '--lblsin'.
            I.e. you can add your own comments.
        --lblsin file: Input a file with labels, addresses and comments.
            ...
            label. I.e. the more you know about the disassembled sources the more labels
            you can add here with meaningful comments.
    `);
    }
